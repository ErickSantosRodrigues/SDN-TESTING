...
class MyController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.client1_mac = "00:00:00:00:00:02" # Substitute with actual MAC
        self.client2_mac = "00:00:00:00:00:03" # Substitute with actual MAC
        ...
        if eth.ethertype == ether_types.ETH_TYPE_IP:
            ...
            if self.client1_streaming:
                ...
                if eth.src == self.client2_mac:
                    ...
                    actions = [event.msg.datapath.ofproto_parser.OFPActionOutput(odp.OFPP_FLOOD)]
