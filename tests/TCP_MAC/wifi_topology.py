...
def run():
    ...
    sta4.cmd('''xterm -geometry 80x24+1075+0 -hold -T "sta4_5003" -e "iperf3 -s --port 5003 " &''')
    sleep(5)
    ...
    sta3.cmd('''xterm -geometry 80x24+1075+380 -hold -T "sta3" -e "iperf3 -c 10.0.0.4 --port 5003 -t 60 -i 60" &''')
    CLI(net)
    net.stop()
