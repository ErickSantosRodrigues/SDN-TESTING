...
def run():
    ...
    net.pingAll()
    sta1.cmd('''xterm -geometry 80x24+0+0 -hold -T "sta1_5002" -e "iperf3 -s --port 5002 > ~/Desktop/server1.txt" &''')
    sta1.cmd('''xterm -geometry 80x24+625+0 -hold -T "sta1_5003" -e "iperf3 -s --port 5003 > ~/Desktop/server2.txt" &''')
    sleep(5)
